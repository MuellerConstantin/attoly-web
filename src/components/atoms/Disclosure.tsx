...
const disclosure = tv({
  base: "group min-w-64 border border-gray-200 dark:border-slate-600 rounded-lg text-gray-900 dark:text-slate-200",
  variants: {
    isInGroup: {
...
const chevron = tv({
  base: "w-5 h-5 shrink-0 text-gray-500 dark:text-gray-400 transition-transform duration-200 ease-in-out",
  variants: {
    isExpanded: {
