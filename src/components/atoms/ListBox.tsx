...
export const itemStyles = tv({
  ...
  variants: {
    isSelected: {
      ...
      true: "bg-orange-500 text-white forced-colors:bg-[Highlight] forced-colors:text-[HighlightText] [&:has(+[data-selected])]:rounded-b-none [&+[data-selected]]:rounded-t-none -outline-offset-4 outline-white dark:outline-white forced-colors:outline-[HighlightText]",
    },
    isDisabled: {
...
export const dropdownItemStyles = tv({
  ...
  variants: {
    ...
    isFocused: {
      true: "bg-orange-500 text-white forced-colors:bg-[Highlight] forced-colors:text-[HighlightText]",
    },
  },
  compoundVariants: [
    {
